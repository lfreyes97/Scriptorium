...
const ProjectManagerView = () => {
  ...
  const [projects, setProjects] = useState<ProjectSummary[]>(PROJECT_LIST);
  const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  const handleSaveProject = (data: Partial<ProjectSummary>) => {
      if (editingProject) {
          // Update existing
          ...
          const newProject: ProjectSummary = {
              ...
              members: ['https://picsum.photos/id/101/40/40'], // Default member
